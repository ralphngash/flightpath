...
(function () {
  ...
  (function initIntro() {
    ...
    let finished = false;
    let autoTimer;
    const INTRO_MS = 4000; // two flybys + low pass (shorter than 3-plane intro)
  ...
  function onScroll() {
    if (!header) return;
    if (window.scrollY > 40 || document.body.classList.contains("menu-page")) {
